    ...
    <body>
        ...
        <div id="wrapper"><div id="menu">
                <ul> <!-- class="current_page_item"-->
                    ...
                    <li class="current_page_item"><a style="border: 1px solid #ff7700;" href="View/Contactos1.php"  target="ventana">CONTACTOS</a></li>
                    <li class="current_page_item"><a style="border: 1px solid #ff7700;" href="View/Reservaciones1.php"  target="ventana">RESERVACIONES</a></li>
                </ul>
            </div></div>
